...
/**
 * Displays the calculated Total ATK broken down by source.
 *
 * Values are automatically derived from all ATK-contributing state slices —
 * the same inputs used in the DMG Efficiency calculation.
 */
