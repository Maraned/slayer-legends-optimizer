...
export function WeaponSelector() {
  ...
  const setWeaponId = useCalculatorInputsStore((s: CalculatorInputsStore) => s.setWeaponId);
  const setWeaponCurrentLevel = useCalculatorInputsStore(
    (s: CalculatorInputsStore) => s.setWeaponCurrentLevel,
  );
  const setWeaponTargetLevel = useCalculatorInputsStore(
    (s: CalculatorInputsStore) => s.setWeaponTargetLevel,
  );
  ...
  const options: SelectOption[] = WEAPONS.map((w) => ({
    value: w.id,
      ...
      <div className="p-6 space-y-4">
        ...
        <div className="grid grid-cols-2 gap-3 pt-2">
          <div className="rounded-lg bg-gray-50 px-4 py-3 dark:bg-gray-800/60">
            ...
            <p className="mt-0.5 text-xs text-gray-400 dark:text-gray-500">at max upgrade</p>
          </div>
